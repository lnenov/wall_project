...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original_index', models.PositiveIntegerField(help_text='1-based index from the input file', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='DailyRecord',
            fields=[
                ...
                ('profile', models.ForeignKey(blank=True, help_text='Null if this is an overall record', null=True, on_delete=django.db.models.deletion.CASCADE, to='construction_api.wallprofile')),
            ],
            options={
                'ordering': ['day', 'is_overall', 'profile__original_index'],
                'indexes': [models.Index(fields=['day', 'is_overall'], name='constructio_day_605be8_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='construction_api.wallprofile')),
            ],
            options={
